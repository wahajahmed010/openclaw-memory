...
**Hermes adaptation:** [HERMES_ADAPTATION.md](./HERMES_ADAPTATION.md)

---

## Hermes Adaptation — Auto-Skill Pipeline

Inspired by [Hermes Agent](https://github.com/NousResearch/Hermes-Agent) by Nous Research, we're adapting their self-improving skill system for Buck.

### The Problem Auto-Skill Solves

Subagents complete useful work every day — but that knowledge dies with the session. If a subagent figures out the perfect way to handle a specific task, why should Buck forget it by tomorrow?

### How It Works

1. **Subagent completes task** (3+ tool calls)
2. **Skill Extractor** analyzes the transcript
3. **DRAFT skill** created in `skills/auto-draft/`
4. **After 3 successful re-invocations:** promoted to `skills/auto/`
5. **User always controls** — browse, edit, or delete anytime

### Safety Guardrails

- 24-hour review window for subagent-created skills
- DRAFT mode prevents clutter until proven useful
- Auto-archive after 7 days unused
- User curates the final skill library

### Why the Council?

Three LLMs negotiated this implementation:
...
See full details: [HERMES_ADAPTATION.md](./HERMES_ADAPTATION.md)
